...
Studentski projekt iz kolegija Napredno web programiranje. Aplikacija **agregira događanja u Zagrebu iz tri različita tipa izvora podataka**, sprema ih u MySQL bazu i nudi kroz responzivno web sučelje te **vlastiti XML/JSON API**.
